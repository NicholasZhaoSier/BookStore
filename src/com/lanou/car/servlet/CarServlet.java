package com.lanou.car.servlet;

import com.lanou.book.domain.Book;
import com.lanou.book.service.impl.BookServiceImpl;
import com.lanou.car.domain.CarBean;
import com.lanou.car.domain.CarBigBean;
import com.lanou.car.service.impl.CarServiceImpl;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (method) {
            ...
            case "find":
                ...
                break;
            case "delByCarId":
                delByCarId(request, response);
                break;
            case "findTop":
                findTop(request, response);
                break;
            case "delByUid":
                delByUid(request, response);
                break;
        }
    }
