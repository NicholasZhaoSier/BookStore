...
public class CarDaoImpl implements CarDao {
    ...
    public boolean addOrder(CarBean carBean) {
        ...
        try {
            flag = queryRunner.update(sql,carBean.getCarid(),carBean.getBook().getImage(),carBean.getBook().getBname(),carBean.getBook().getAnthor(),carBean.getBook().getPrice(),carBean.getCount(),carBean.getSubtotal(),carBean.getUid());
